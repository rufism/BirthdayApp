...
export default function Challenge3() {
  ...
  const { isAuthenticated, completeChallenge3, challenge3Complete } = useGameStore();
                  ...
                  {guess ? (
                    ...
                    <>
                      ...
                      {Array.from({ length: 4 - currentGuess.length }).map((_, i) => (
                        <div key={`empty-${i}`} className={`${styles.digit} ${styles.empty}`}>
                          _
                        </div>
                      ))}
                    </>
                ...
                {guess && (
                  <div className={styles.feedback}>
                    <div className={styles.feedbackItem}>
                      <span className={styles.feedbackLabel}>Correct Position:</span>
                      <span className={styles.feedbackValue}>{guess.correctPosition}</span>
                    </div>
                    <div className={styles.feedbackItem}>
                      <span className={styles.feedbackLabel}>Correct Digit:</span>
                      <span className={styles.feedbackValue}>{guess.correctDigit}</span>
                    </div>
                  </div>
                )}
              </div>
